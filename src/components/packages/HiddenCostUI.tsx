...
const HiddenCostUI = () => {
  return (
    <section data-header-tone="light" className="relative hidden bg-[#020817] sm:block">
      ...
      <div className="relative z-20 bg-white py-8 font-sans lg:pb-24">
        <div className="site-shell flex flex-col items-center justify-center px-2 sm:px-0">
    ...
    >
      ...
      >
        ...
        {/* Chart Container */}
        <div className="relative mt-10 hidden h-[400px] w-full max-w-5xl items-center justify-center md:flex">
