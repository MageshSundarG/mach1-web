export default function AIOperationalVision() {
  ...
  return (
    <section data-header-tone="dark" className="relative overflow-hidden bg-[#020817] text-white">
      <div className="site-shell relative">
        {/* Decorative top border with notch */}
        <div className="pointer-events-none absolute top-10 hidden h-full overflow-visible 2xl:block">
          <img
            src="/assets/about/session4/Subtract.png"
            className="-translate-x-[26.4%] object-contain"
            alt="Image"
          />
        </div>

        <div className="flex min-h-[600px] items-center justify-between py-20 lg:mt-24">
          {/* Left Content */}
