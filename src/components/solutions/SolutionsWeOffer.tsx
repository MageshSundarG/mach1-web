...
export default function SolutionsWeOffer() {
  ...
  const solutions = [
    ...
    },
    {
      ...
      icon: "/assets/solutions/session1/security-icon-1.png",
    },
    {
      title: "AVOP",
      description:
      ...
      icon: "/assets/solutions/session1/avop-icon-1.png",
    },
    {
      ...
      icon: "/assets/solutions/session1/quality-assessment-icon-1.png",
    },
    {
      title: "Training",
      description:
      ...
      icon: "/assets/solutions/session1/training-icon-1.png",
    },
    {
      ...
      icon: "/assets/solutions/session1/lms-training-hub-icon-1.png",
    },
  ];
              ...
              <div className="flex justify-end items-end">
                <div className="flex h-[92px] w-[92px] items-center justify-center text-5xl opacity-80 filter brightness-110">
                  <img
                    ...
                    src={solution.icon}
                    alt="icon"
                    className={`elegant-transition h-[78px] w-[78px] object-contain group-hover:-translate-y-1 group-hover:scale-[1.08] ${solution.isExtractedIcon
