...
export default function OperationsModule({
  ...
  return (
    <>
      <div className="mt-10 bg-[#020617] text-white py-36">
        <div className="">
          {/* Header with Icon */}
          <div className="max-w-[95rem] mx-auto px-4 lg:px-0 flex items-start lg:justify-between mb-12">
          ...
          <div className="max-w-[95rem] mx-auto px-4 lg:px-0">
      ...
      <div className="absolute z-0 w-full 2xl:top-[-94px] xl:top-[-64px] lg:top-[-56px] md:top-[-38px] sm:top-[-32px] top-[-24px] left-1/2 -translate-x-1/2 pointer-events-none">
        ...
        >
          ...
          <div className="max-w-[95rem] mx-auto py-24 mb-16 px-4 lg:px-0">
            {/* Header */}
            {/* <div className="mb-12">
