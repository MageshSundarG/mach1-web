...
const Airport = () => {
  return (
    <div data-header-tone="light" className="relative isolate overflow-hidden bg-white">
  ...
  <svg width="120" height="40" viewBox="0 0 120 40" className="block">
    ...
    />
        ...
        {/* --- Hero Section --- */}
        <header className="site-shell mx-auto pt-16 text-center">
          <h1
            data-aos="fade-down"
            className="title-balanced mx-auto mb-6 max-w-2xl text-[36px] font-regular text-black md:text-5xl lg:text-[56px]"
          >
            Airport-Wide
...
">Operational</span> <br /> */}
          ...
          <p className="copy-balanced mx-auto mb-12 max-w-5xl text-center text-[16px] font-regular text-[#1A1A1A] md:text-base">
