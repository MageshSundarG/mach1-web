...
const AirportOpsLanding = () => {
  return (
    <div className="bg-[#020817] text-white font-sans selection:bg-blue-500/30">
      {/* Main Container */}
      <div className="w-full px-6 2xl:px-0  relative">
        {/* Background Glows */}
        ...
        <div className="mb-20">
          ...
          <div className="w-full max-w-[95rem] mx-auto overflow-hidden">
            {/* LEFT: Heading */}
            {/* <div className="pb-10">
          ...
          <div className="w-full max-w-[110rem] mx-auto relative">
            <div className="2xl:pl-20 max-w-[60rem]">
              <h3
                data-aos="fade-up"
                className="lg:text-[56px] text-[48px] font-regular tracking-tight leading-tight"
              >
              ...
              <p className="mt-8 max-w-xl text-white text-[16px] font-regular leading-relaxed">
            ...
            <div className="absolute top-0 right-0 hidden 2xl:block overflow-hidden">
              <img
                src="/assets/home/session7/Subtract.png"
        ...
        {/* Sticky Grid Layout */}
        <div className="grid grid-cols-1 lg:grid-cols-2 items-start max-w-[95rem] mx-auto pb-20">
          ...
          <div className="lg:pl-20">
            ...
            <section className="group">
              <h3 className="md:text-[36px] text-[28px] font-regular group-hover:text-blue-400 transition-colors">
                Mobile-First Application
              </h3>
              <p className="text-white text-[14px] font-regular leading-relaxed">
            ...
            {/* Feature 2 */}
            <section className="group">
              <h3 className="md:text-[36px] text-[28px] font-regular mb-6 group-hover:text-blue-400 transition-colors">
                Voice Notes
              </h3>
              <p className="text-white text-[14px] font-regular leading-relaxed">
