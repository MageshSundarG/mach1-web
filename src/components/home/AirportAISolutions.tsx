...
const ModuleCard = ({
  ...
  return (
    <div
      ...
      className={`
         ...
         sticky w-[90%] lg:w-[100%] max-w-[95rem] mx-auto mb-8 rounded-3xl border border-white/10 py-12 lg:pl-32 lg:px-20 px-6 flex flex-col md:flex-row items-center`}
    >
  ...
  "
        ...
        <h2
          data-aos="fade-up"
          className="text-[28px] sm:text-[36px] py-2 font-regular bg-gradient-to-r from-[#167EFF] to-[#90C63D] bg-clip-text text-transparent leading-tight"
        >
          {title}
          <br />
        ...
        <p className="text-white text-[16px] font-regular leading-relaxed max-w-xl">
          {description}
        </p>
        {/* <button
          data-aos="fade-left"
...
export default function AirportAISolutions() {
  return (
    ...
    <div className="bg-[#020817] text-white py-36 font-sans">
      <img
      ...
      <div className="text-center mb-20">
        ...
        <h1 className="lg:text-[56px] text-[38px] px-6 leading-tight font-regular mt-6 mb-4">
          Our AI solutions
        </h1>
        <p className="text-center max-w-5xl mx-auto px-10 text-white font-regular text-[16px]">
